...
class TasaInteresCompuestaPage extends ConsumerWidget {

  const TasaInteresCompuestaPage({super.key});
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                Text(
                  'Para hallar la Tasa de Interes se utiliza la siguiente formula: Tasa de Interés \n(i) = (VF / C)^(1/N) - 1\nDonde C es capital, VF es Valor futuro o Monto final y N es tiempo',
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(montoForm.isValid) {
                        ...
                        double tasaInteres = MontoCalculator.calcularTasainteresCompuesta(montoForm.interes.value,double.parse(montoForm.capital.value.toString()), montoForm.tiempo.value, tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return PushNotificator(data: tasaInteres*100, title: 'Resultado',content: 'Tasa de Interes: ',simbolo: '%',);
                          },
                        );
