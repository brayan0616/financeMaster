...
class MontoPeridoPage extends ConsumerWidget {

  const MontoPeridoPage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(montoForm.isValid) {
                        ...
                        List<double> capital = MontoCalculator.calcularMonto(double.parse(montoForm.capital.value.toString()), montoForm.interes.value/100, montoForm.tiempo.value, tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return PushNotificator(
                              content: 'Monto por periodo: ${capital.map((double value) => value.toStringAsFixed(0)).join(', ')}',
                              title: 'Resultado',
                            );
                          },
                        );
