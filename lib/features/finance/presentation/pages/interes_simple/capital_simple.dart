...
class CapitalSimplePage extends ConsumerWidget {

  const CapitalSimplePage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(montoForm.isValid) {
                        ...
                        double capital = MontoCalculator.calcularCapital(montoForm.capital.value, montoForm.interes.value, montoForm.tiempo.value, tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return _PushNotificator(interes: capital, title: 'Capital',);
                          },
                        );
...
class _PushNotificator extends StatefulWidget {
  const _PushNotificator({
  ...
  @override
  State<_PushNotificator> createState() => _PushNotificatorState();
}

class _PushNotificatorState extends State<_PushNotificator> {
  ...
  Widget build(BuildContext context) {
    ...
    ? ZoomIn(
      ...
      child: AlertDialog(
        ...
        content: Text('El ${widget.title} es: ${widget.interes}', style: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 16),),
        actions: [
          FilledButton(
        ...
        child: AlertDialog(
          title: Text('Monto Final', style: textStyle.titleSmall?.copyWith(color: colors.primary, fontSize: 20,fontWeight: FontWeight.bold),),
          content: Text('El Interes es: ${widget.interes}', style: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 16),),
          actions: [
            FilledButton(
              onPressed: _closeDialog,
              style: ButtonStyle(
