...
class MontoSimplePage extends ConsumerWidget {

  const MontoSimplePage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Monto Simple', style: TextStyle(color: colors.primary)),
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(montoForm.isValid) {
                        ...
                        double montoFinal = MontoCalculator.calcularMontoFinal(montoForm.capital.value, montoForm.interes.value, montoForm.tiempo.value, tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              ...
                              content: Text('El monto final es: $montoFinal', style: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 16),),
                              actions: [
                                FilledButton(
                                  onPressed: () {
