...
class InteresSimplePage extends ConsumerWidget {

  const InteresSimplePage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(montoForm.isValid) {
                        ...
                        double interes = MontoCalculator.calcularInteres(montoForm.capital.value, montoForm.interes.value, montoForm.tiempo.value, tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              ...
                              content: Text('El Interes es: $interes', style: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 16),),
                              actions: [
                                FilledButton(
                                  onPressed: () {
