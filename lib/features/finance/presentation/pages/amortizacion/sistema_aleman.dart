...
class SistemaAlemanPage extends ConsumerWidget {

  const SistemaAlemanPage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(monto.isValid) {
                        ...
                        final resultado = MontoCalculator.calcularSistemaAleman(double.parse(monto.capital.value.toString()), monto.interes.value/100,double.parse(monto.tiempo.value.toString()), tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            ...
                            double principal = double.parse(monto.capital.value.toString());
