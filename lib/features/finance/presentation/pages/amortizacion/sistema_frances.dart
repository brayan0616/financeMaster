...
class SistemaFrancesPage extends ConsumerWidget {

  const SistemaFrancesPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final monto = ref.watch(montoSimpleFormNotifierProvider);
            ...
            child: Column(
              children: [
                ...
                Math.tex(
                  ...
                  textStyle: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 20,fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 10,),
                Text(
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(monto.isValid) {
                        ...
                        final resultado = MontoCalculator.calcularSistemaFrances(double.parse(monto.capital.value.toString()), monto.interes.value/100,double.parse(monto.tiempo.value.toString()), tiempoCurrent.name);
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return PushNotificator(
                              title: 'Resultado',
                              content: 'Cuota Mensual: \$${resultado['cuotaMensual']?.toStringAsFixed(2)}\nTotal: \$${resultado['totalDevolver']?.toStringAsFixed(2)}',
                            );
                          },
                        );
