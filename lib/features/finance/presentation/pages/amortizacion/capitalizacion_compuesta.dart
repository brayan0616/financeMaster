...
class CapitalizacionCompuestaPage extends ConsumerWidget {

  const CapitalizacionCompuestaPage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(monto.isValid) {
                        ...
                        double capital = MontoCalculator.calcularCapitalizacionCompuesta(double.parse(monto.capital.value.toString()), monto.interes.value/100, monto.tiempo.value, tiempoCurrent.name);
