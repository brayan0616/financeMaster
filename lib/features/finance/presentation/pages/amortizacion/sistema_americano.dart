...
class SistemaAmericanoPage extends ConsumerWidget {

  const SistemaAmericanoPage({super.key});
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(monto.isValid) {
                        ...
                        final resultado = MontoCalculator.calcularSistemaAmericano(double.parse(monto.capital.value.toString()), monto.interes.value/100, monto.tiempo.value, tiempoCurrent.name);
