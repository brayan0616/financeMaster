...
class CapitalizacionSimplePage extends ConsumerWidget {

  const CapitalizacionSimplePage({super.key});
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Math.tex(
                  r'I\:=\:CiN',
                  textStyle: textStyle.titleSmall?.copyWith(color: colors.secondary, fontSize: 20),
                ),
                Text(
                  ...
                  child: CustomFilledButton(
                    ...
                    onPressed: () {
                      ...
                      if(monto.isValid) {
                        ...
                        double capital = MontoCalculator.calcularCapitalizacionSimple(double.parse(monto.capital.value.toString()), monto.interes.value/100, monto.tiempo.value, tiempoCurrent.name);
